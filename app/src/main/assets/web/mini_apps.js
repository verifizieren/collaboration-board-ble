...
var miniAppDirectory = "miniApps/"; // Default directory for Android asset mini apps
...
if (document.readyState === "loading") {
    document.addEventListener("DOMContentLoaded", initializeMiniApps);
} else {
    initializeMiniApps();
}
...
function initializeMiniApps() {
    ...
    fetch(miniAppsUrl + "apps.json")
        ...
        .catch(() => {
            console.log("apps.json not found, falling back to Collaboration Board");
            loadMiniAppManifests(["collabboard"], miniAppsUrl);
        });
}
