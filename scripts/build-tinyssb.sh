...
grep -Fq "whiteboard_members_confirmed()" "$TMP_DIR/tremola.js"
grep -Fq "whiteboard_members_cancelled()" "$TMP_DIR/tremola_ui.js"
grep -Fq "'whiteboard': ['div:back', 'core', 'div:collabboard-main']" "$TMP_DIR/tremola_ui.js"
